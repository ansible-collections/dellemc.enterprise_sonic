.. _dellemc.enterprise_sonic.sonic_bgp_neighbors_module:
...
**Manage a BGP neighbor and its parameters**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the BGP neighbors related configuration.</div>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the minimum interval between sending BGP routing updates.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Configuration for neighbor group authentication password.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Authentication password for the neighbor group.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enables or disables BFD.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Link dataplane status with control plane.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables BFD liveliness check for a BGP neighbor.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies capability attributes to this neighbor.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables or disables dynamic capability to this neighbor.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables or disables advertise extended next-hop capability to the peer.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Disables EBGP conntected route check.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Disables capability negotiation.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables the referenced group or neighbors to be indirectly connected.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Time-to-live value to use when packets are sent to the referenced group or neighbors and ebgp-multihop is enabled.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enforces the first AS for EBGP routes.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enforces EBGP multihop performance for neighbor.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Configure the Link Bandwidth extended community for a BGP neighbor.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set the local IP address to use for the session when sending BGP update messages.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specifies local autonomous system number.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Do not prepend the local-as number in AS-Path advertisements.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Replace the configured AS Number with the local-as number in AS-Path advertisements.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>A textual description of the neighbor.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Override capability negotiation result.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Do not send open messages to this neighbor.</div>
                        <div>Default value while adding a new neighbor is <code>False</code>.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The name of the peer group that the neighbor is a member of.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>peer_as and peer_type are mutually exclusive.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specifies remote AS number.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the type of BGP peer.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Add a shutdown message.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Indicates that routes advertised by the peer should not be reflected back to the peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables strict capability negotiation match.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Interval after not receiving a keepalive message that SONiC declares a peer dead, in seconds.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Frequency with which the device sends keepalive messages to its peer, in seconds.</div>
                        <div>The range is from 0 to 65535.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enforces only the neighbors that are specified number of hops away will be allowed to become neighbors.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables BGP with v6 link-local only.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the list of peer groups.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Holds of list of address families associated to the peergroup.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>List of address families with afi, safi, activate and allowas-in parameters.</div>
                ...
                <td>
                        <div>Enable or disable activate.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Enable or disable sending of default-route to the peer.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Maximum number of prefixes that will be accepted from the peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Threshold on number of prefixes that can be received from a peer before generation of warning messages.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Inbound route filtering policy for a peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Outbound route filtering policy for a peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Configuration for peer group authentication password.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Authentication password for the peer group.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enables BFD liveliness check for a BGP peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies capability attributes to this peer group.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables or disables dynamic capability to this peer group.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Allow EBGP peers not on directly connected networks.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enables the referenced group or peers to be indirectly connected.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Enforces EBGP multihop performance for peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Configure the Link Bandwidth extended community for a BGP peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Do not send open messages to this peer.</div>
                        <div>Default value while adding a new peergroup is <code>False</code>.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>A textual description of the peer group.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Remote AS of the BGP peer group to configure.</div>
                        <div>peer_as and peer_type are mutually exclusive.</div>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies BGP peer group timer related configurations.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Interval after not receiving a keepalive message that Enterprise SONiC declares a peer dead, in seconds.</div>
                        <div>The range is from 0 to 65535.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enforces only the peers that are specified number of hops away will be allowed to become peers.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>In case of replaced, the existing BGP configuration will be replaced with the input BGP configuration on the device.</div>
                        <div>In case of overridden, the existing BGP configuration will be overriden with the input BGP configuration on the device.</div>
                </td>
            </tr>
    </table>
    <br/>
