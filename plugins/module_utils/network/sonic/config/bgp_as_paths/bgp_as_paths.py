...
class Bgp_as_paths(ConfigBase):
    ...
    def get_delete_single_as_path_member_requests(self, name, members):
        url = "data/openconfig-routing-policy:routing-policy/defined-sets/openconfig-bgp-policy:bgp-defined-sets/as-path-sets/as-path-set={name}/config/{members_param}"
        method = "DELETE"
