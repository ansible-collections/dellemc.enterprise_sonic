    ...
    def update_qos_interfaces(self, module):
        ...
        if interfaces:
            for intf in interfaces:
                ...
                if ('openconfig-qos-buffer:cable-length' in intf and 'config' in intf['openconfig-qos-buffer:cable-length'] and 'length' in intf['openconfig-qos-buffer:cable-length']['config']):
