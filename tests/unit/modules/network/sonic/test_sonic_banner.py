...
class TestSonicBannerModule(TestSonicModule):
    module = sonic_banner

    @classmethod
    def setUpClass(cls):
        cls.mock_facts_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.facts.banner.banner.edit_config"
        )
        cls.mock_config_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.config.banner.banner.edit_config"
        )
        ...
        cls.fixture_data = cls.load_fixtures('sonic_banner.yaml')

    def setUp(self):
        super(TestSonicBannerModule, self).setUp()
    ...
    def tearDown(self):
        super(TestSonicBannerModule, self).tearDown()
        self.mock_facts_edit_config.stop()
        self.mock_config_edit_config.stop()
        self.mock_utils_edit_config.stop()

    def test_sonic_banner_merged_01(self):
    ...
    def test_sonic_banner_deleted_01(self):
    ...
    def test_sonic_banner_replaced_01(self):
    ...
    def test_sonic_banner_overridden_01(self):
