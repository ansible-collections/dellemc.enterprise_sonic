...
class TestSonicIpNeighborInterfacesModule(TestSonicModule):
    module = sonic_ip_neighbor_interfaces

    @classmethod
    def setUpClass(cls):
        cls.mock_facts_edit_config = patch(
            'ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.facts.{0}.{0}.edit_config'.format('ip_neighbor_interfaces')
        )
        cls.mock_config_edit_config = patch(
            'ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.config.{0}.{0}.edit_config'.format('ip_neighbor_interfaces')
        )
        ...
        cls.fixture_data = cls.load_fixtures('sonic_ip_neighbor_interfaces.yaml')

    def setUp(self):
        super(TestSonicIpNeighborInterfacesModule, self).setUp()
    ...
    def tearDown(self):
        super(TestSonicIpNeighborInterfacesModule, self).tearDown()
        self.mock_facts_edit_config.stop()
        self.mock_config_edit_config.stop()
        self.mock_get_interface_naming_mode.stop()

    def test_sonic_ip_neighbor_interfaces_merged_01(self):
    ...
    def test_sonic_ip_neighbor_interfaces_deleted_01(self):
    ...
    def test_sonic_ip_neighbor_interfaces_deleted_02(self):
    ...
    def test_sonic_ip_neighbor_interfaces_replaced_01(self):
    ...
    def test_sonic_ip_neighbor_interfaces_overridden_01(self):
    ...
    def test_sonic_ip_neighbor_interfaces_overridden_02(self):
