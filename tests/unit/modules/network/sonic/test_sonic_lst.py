...
class TestSonicLstModule(TestSonicModule):
    module = sonic_lst

    @classmethod
    def setUpClass(cls):
        cls.mock_facts_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.facts.lst.lst.edit_config"
        )
        cls.mock_config_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.config.lst.lst.edit_config"
        )
        ...
        cls.fixture_data = cls.load_fixtures('sonic_lst.yaml')

    def setUp(self):
        super(TestSonicLstModule, self).setUp()
