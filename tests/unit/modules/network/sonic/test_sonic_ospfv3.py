...
class TestSonicOspfv3Module(TestSonicModule):
    module = sonic_ospfv3

    @classmethod
    def setUpClass(cls):
        cls.mock_facts_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.facts.ospfv3.ospfv3.edit_config"
        )
        cls.mock_config_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.config.ospfv3.ospfv3.edit_config"
        )
        ...
        cls.fixture_data = cls.load_fixtures('sonic_ospfv3.yaml')

    def setUp(self):
        super(TestSonicOspfv3Module, self).setUp()
    ...
    def tearDown(self):
        super(TestSonicOspfv3Module, self).tearDown()
        self.mock_facts_edit_config.stop()
        self.mock_config_edit_config.stop()
        self.mock_bgp_utils_edit_config.stop()
        self.mock_get_interface_naming_mode.stop()

    def test_sonic_ospfv3_merged_01(self):
    ...
    def test_sonic_ospfv3_merged_02(self):
    ...
    def test_sonic_ospfv3_deleted_01(self):
    ...
    def test_sonic_ospfv3_deleted_02(self):
    ...
    def test_sonic_ospfv3_replaced_01(self):
    ...
    def test_sonic_ospfv3_overridden_01(self):
