...
class TestSonicPasswordComplexityModule(TestSonicModule):
    module = sonic_password_complexity

    @classmethod
    def setUpClass(cls):
        cls.mock_facts_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.facts.password_complexity.password_complexity.edit_config"
        )
        cls.mock_config_edit_config = patch(
            "ansible_collections.dellemc.enterprise_sonic.plugins.module_utils.network.sonic.config.password_complexity.password_complexity.edit_config"
        )
        ...
        cls.fixture_data = cls.load_fixtures('sonic_password_complexity.yaml')

    def setUp(self):
        super(TestSonicPasswordComplexityModule, self).setUp()
    ...
    def tearDown(self):
        super(TestSonicPasswordComplexityModule, self).tearDown()
        self.mock_facts_edit_config.stop()
        self.mock_config_edit_config.stop()
        self.mock_utils_edit_config.stop()

    def test_sonic_password_complexity_merged_01(self):
    ...
    def test_sonic_password_complexity_deleted_01(self):
    ...
    def test_sonic_password_complexity_replaced_01(self):
    ...
    def test_sonic_password_complexity_overridden_01(self):
