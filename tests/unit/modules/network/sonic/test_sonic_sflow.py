...
class TestSonicInterfacesModule(TestSonicModule):
    ...
    def test_sonic_static_routes_merged_02(self):
        set_module_args(self.fixture_data['merged_02']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['merged_02']['existing_static_routes_config'])
        result = self.execute_module(changed=False)
        self.validate_config_requests()

    def test_sonic_static_routes_merged_03(self):
        set_module_args(self.fixture_data['merged_03']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['merged_03']['existing_static_routes_config'])
        result = self.execute_module(changed=False)
        self.validate_config_requests()
    ...
    def test_sonic_static_routes_deleted_03(self):
        set_module_args(self.fixture_data['deleted_03']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['deleted_03']['existing_static_routes_config'])
        self.initialize_config_requests(self.fixture_data['deleted_03']['expected_config_requests'])
        result = self.execute_module(changed=True)
        self.validate_config_requests()

    def test_sonic_static_routes_deleted_04(self):
        set_module_args(self.fixture_data['deleted_04']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['deleted_04']['existing_static_routes_config'])
        self.initialize_config_requests(self.fixture_data['deleted_04']['expected_config_requests'])
        result = self.execute_module(changed=True)
        self.validate_config_requests()

    def test_sonic_static_routes_deleted_05(self):
        set_module_args(self.fixture_data['deleted_05']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['deleted_05']['existing_static_routes_config'])
        result = self.execute_module(changed=False)
        self.validate_config_requests()

    def test_sonic_static_routes_deleted_06(self):
        set_module_args(self.fixture_data['deleted_06']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['deleted_06']['existing_static_routes_config'])
    ...
    def test_sonic_static_routes_overridden_02(self):
        set_module_args(self.fixture_data['overridden_02']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['overridden_02']['existing_static_routes_config'])
        self.initialize_config_requests(self.fixture_data['overridden_02']['expected_config_requests'])
        result = self.execute_module(changed=True)
        self.validate_config_requests()
    
    def test_sonic_static_routes_replaced_01(self):
    ...
    def test_sonic_static_routes_replaced_02(self):
