...
class TestSonicSnmpModule(TestSonicModule):
    ...
    def test_sonic_snmp_merged_04(self):
        set_module_args(self.fixture_data['merged_04']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['merged_04']['existing_snmp_config'])
    ...
    def test_sonic_snmp_replaced_03(self):
        set_module_args(self.fixture_data['replaced_03']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['replaced_03']['existing_snmp_config'])
