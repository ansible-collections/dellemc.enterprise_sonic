...
class TestSonicSystemModule(TestSonicModule):
    module = sonic_system
    ...
    def test_sonic_system_merged_02(self):
        set_module_args(self.fixture_data['merged_02']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['merged_02']['existing_system_config'])
    ...
    def test_sonic_system_deleted_03(self):
        set_module_args(self.fixture_data['deleted_03']['module_args'])
        self.initialize_facts_get_requests(self.fixture_data['deleted_03']['existing_system_config'])
